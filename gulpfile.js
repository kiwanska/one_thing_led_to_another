...
gulp.task('sass', function(){
	return gulp.src('scss/*.scss')
		.pipe(sass({errLogToConsole:true, 
			outputStyle: 'compact', //nested jest domyślny, expanded najbardziej przyjazny (czytelny), compact rezygnuje z enterów i spacji, compressed tworzy najmniejszy możliwy plik
			sourceComments: 'map'}))
		.pipe(gulp.dest('css'))
});
